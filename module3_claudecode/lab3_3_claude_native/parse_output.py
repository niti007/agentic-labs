"""Lab 3.3 (Claude-native) - parse Claude's structured review JSON into a CI gate.
...
Usage:
    ...
    py parse_output.py sample_review_fail.json   # ships with this lab
    py parse_output.py sample_review_pass.json   # ships with this lab
