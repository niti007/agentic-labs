...
This is **Lab 3.2's path-specific rule file**. Because it lives in `src/auth/`,
Claude Code loads it only when working on files in this directory — so the
strict rules stay relevant and don't pollute unrelated work.
